...
class DatabaseService with ChangeNotifier {
  ...
  Future<void> fetchUsers() async {
    ...
    try {
      final response = await http.get(Uri.parse('https://raamb-admin1-nvky-kifebaepb-cravewolf.vercel.app/users')); // Update with your server URL
  ...
  Future<void> fetchVerificationRequests() async {
    try {
      final response = await http.get(Uri.parse('https://raamb-admin1-nvky-kifebaepb-cravewolf.vercel.app/verification-requests')); // Update with your server URL
      if (response.statusCode == 200) {
